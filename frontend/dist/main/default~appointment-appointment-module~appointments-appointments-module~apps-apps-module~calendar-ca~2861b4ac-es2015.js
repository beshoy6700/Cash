(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~appointment-appointment-module~appointments-appointments-module~apps-apps-module~calendar-ca~2861b4ac"],{
...
const matDialogAnimations = {
    ...
    dialogContainer: Object(_angular_animations__WEBPACK_IMPORTED_MODULE_10__["trigger"])('dialogContainer', [
        // Note: The `enter` animation transitions to `transform: none`, because for some reason
        // specifying the transform explicitly, causes IE both to blur the dialog content and
        // decimate the animation performance. Leaving it as `none` solves both issues.
        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_10__["state"])('void, exit', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_10__["style"])({ opacity: 0, transform: 'scale(0.7)' })),
        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_10__["state"])('enter', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_10__["style"])({ transform: 'none' })),
        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_10__["transition"])('* => enter', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_10__["animate"])('150ms cubic-bezier(0, 0, 0.2, 1)', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_10__["style"])({ transform: 'none', opacity: 1 }))),
        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_10__["transition"])('* => void, * => exit', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_10__["animate"])('75ms cubic-bezier(0.4, 0.0, 0.2, 1)', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_10__["style"])({ opacity: 0 }))),
    ])
};
...
class _MatDialogContainerBase extends _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_1__["BasePortalOutlet"] {
    ...
    _restoreFocus() {
        ...
        if (this._config.restoreFocus && previousElement &&
            ...
            const activeElement = Object(_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_9__["_getFocusedElementPierceShadowDom"])();
    ...
    _capturePreviouslyFocusedElement() {
        if (this._document) {
            this._elementFocusedBeforeDialogWasOpened = Object(_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_9__["_getFocusedElementPierceShadowDom"])();
        }
    }
...
class MatDialogRef {
    constructor(_overlayRef, _containerInstance, id = `mat-dialog-${uniqueId++}`) {
        ...
        _overlayRef.keydownEvents()
            ...
            return event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_11__["ESCAPE"] && !this.disableClose && !Object(_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_11__["hasModifierKey"])(event);
        }))
            .subscribe(event => {
...
//# sourceMappingURL=default~appointment-appointment-module~appointments-appointments-module~apps-apps-module~calendar-ca~2861b4ac-es2015.js.map