                                ...
                                <table id="recent-orders" class="table table-hover table-xl mb-0">
                                    ...
                                    <tr>
                                        <td class="text-truncate p-1 border-top-0">
                                            <div class="avatar avatar-md">
                                                <img class="media-object rounded-circle" src="{{asset('modern/app-assets/images/portrait/small/avatar-s-4.png')}}"
                                                     alt="Avatar">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-truncate p-1">
                                            <div class="avatar avatar-md">
                                                <img class="media-object rounded-circle" src="{{asset('modern/app-assets/images/portrait/small/avatar-s-7.png')}}"
                                                     alt="Avatar">
                                            </div>
                                        </td>
                                        <td class="text-truncate pl-0 border-top-0">
                                    ...
                                    <tr>
                                        <td class="text-truncate p-1">
                                            <div class="avatar avatar-md">
                                                <img class="media-object rounded-circle" src="{{asset('modern/app-assets/images/portrait/small/avatar-s-1.png')}}"
                                                     alt="Avatar">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-truncate p-1">
                                            <div class="avatar avatar-md">
                                                <img class="media-object rounded-circle" src="{{asset('modern/app-assets/images/portrait/small/avatar-s-11.png')}}"
                                                     alt="Avatar">
                                            </div>
                                        </td>
                                        <td class="text-truncate pl-0 border-top-0">
                                    ...
                                    <tr>
                                        <td class="text-truncate p-1 border-bottom-0 ">
                                            <div class="avatar avatar-md">
                                                <img class="media-object rounded-circle" src="{{asset('modern/app-assets/images/portrait/small/avatar-s-6.png')}}"
                                                     alt="Avatar">
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-truncate p-1">
                                            <ul class="list-unstyled users-list m-0">
                                                ...
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{asset('modern/app-assets/images/portrait/small/avatar-s-5.png')}}"
                                                         alt="Avatar">
                                                </li>
                                    ...
                                    <tr class="pull-up">
                                        ...
                                        <td class="text-truncate p-1">
                                            <ul class="list-unstyled users-list m-0">
                                                ...
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{asset('modern/app-assets/images/portrait/small/avatar-s-8.png')}}"
                                                         alt="Avatar">
                                                </li>
                                                <li class="avatar avatar-sm">
                                    ...
                                    <tr class="pull-up">
                                        ...
                                        <td class="text-truncate p-1">
                                            <ul class="list-unstyled users-list m-0">
                                                ...
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{asset('modern/app-assets/images/portrait/small/avatar-s-2.png')}}"
                                                         alt="Avatar">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Rebecca Jones" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{asset('modern/app-assets/images/portrait/small/avatar-s-3.png')}}"
                                                         alt="Avatar">
                                                </li>
                                                <li class="avatar avatar-sm">
                                    ...
                                    <tr class="pull-up">
                                        ...
                                        <td class="text-truncate p-1">
                                            <ul class="list-unstyled users-list m-0">
                                                ...
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{asset('modern/app-assets/images/portrait/small/avatar-s-12.png')}}"
                                                         alt="Avatar">
                                                </li>
                                            </ul>
                                        </td>
