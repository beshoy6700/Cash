...
@section('title','اضافة تصنيف مصروف جديد')
@section('content')
    ...
    <div class="content-header row">
        ...
        <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    {{ Breadcrumbs::render('create_expensive') }}
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title text-center"
                        id="basic-layout-round-controls">اضافة تصنيف مصروف جديد</h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        {!! Form::open(array('route'=>'expensives.store','class'=>'form-horizontal','files'=>true,'role'=>'form')) !!}
                        @csrf
                        <div class="form-body">
                            <div class="row">
                            ...
                            <div class="row hidden" id="cats_list">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="parent_id">المصروفات</label>
                                        {!! Form::select("parent_id",$expensives,null,array('class'=>'form-control round','placeholder'=>'المصروفات','autocomplete'=>'off')) !!}
                                    </div>
                                    @error("parent_id")
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                            ...
                            <div class="form-actions">
                                ...
                                <a href="{{route('expensives')}}" class="btn btn-warning mr-1">
