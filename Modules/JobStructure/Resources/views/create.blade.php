...
@section('title','اضافة مسمي وظيفي')
@section('content')
    <!-- Content Header (Page header) -->
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-1">
            <h2 class="content-header-title">
                <strong>قسم شئون العاملين</strong>
            </h2>
        </div>
        <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    {{ Breadcrumbs::render('create_jobStructure') }}
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title text-center"
                        id="basic-layout-round-controls">
                        <strong>اضافة مسمي وظيفي</strong></h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        {!! Form::open(array('route'=>'jobStructure.store','class'=>'form-horizontal','files'=>true,'role'=>'form')) !!}
                        @csrf
                        <div class="form-body">
                            <div class="row">
                            ...
                            <div class="row hidden" id="cats_list">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="parent_id">الوظائف</label>
                                        {!! Form::select("parent_id",$jobs,null,array('class'=>'form-control round','placeholder'=>'الوظائف','autocomplete'=>'off')) !!}
                                    </div>
                                    @error("parent_id")
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                            ...
                            <div class="form-actions">
                                ...
                                <a href="{{route('jobStructure')}}" class="btn btn-warning mr-1">
