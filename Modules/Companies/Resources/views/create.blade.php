...
@section('title','اضافة شركة جديدة')
@section('content')
    ...
    <div class="content-header row">
        ...
        <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    {{ Breadcrumbs::render('create_company') }}
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title text-center"
                        id="basic-layout-round-controls">اضافة شركة جديدة</h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        {!! Form::open(array('route'=>'companies.store','class'=>'form-horizontal','files'=>true,'role'=>'form')) !!}
                        @csrf
                        <div class="form-body">
                            <div class="row">
                            ...
                            <div class="form-actions">
                                ...
                                <a href="{{route('companies')}}" class="btn btn-warning mr-1">
