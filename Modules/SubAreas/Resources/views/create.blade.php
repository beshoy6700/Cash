    ...
    <div class="content-header row">
        ...
        <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    {{ Breadcrumbs::render('create_subArea') }}
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title text-center" id="basic-layout-round-controls"><strong>اضافة منطقة جديدة</strong></h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        {!! Form::open(array('route'=>'admin.subAreas.store','class'=>'form-horizontal','files'=>true,'role'=>'form')) !!}
                        @csrf
                        <div class="form-body">
                                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="area_id">المراكز</label>
                                        {!! Form::select("area_id",$areas,null,array('required','class'=>'form-control round select2','placeholder'=>'اختار المحافظة','autocomplete'=>'off')) !!}
                                    </div>
                                    @error("area_id")
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                            ...
                            <div class="form-actions">
                                ...
                                <a href="{{route('admin.subAreas')}}" class="btn btn-warning mr-1">
