            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        {{ Breadcrumbs::render('edit_area',$area) }}
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title text-center"><strong> تعديل {{$area->name}} </strong></h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    {!! Form::model($area, array('method' =>'PATCH','class'=>'form-horizontal','files'=>true,'role'=>'form',
                   'route'=>['areas.update', $area->id])) !!}
                    @csrf
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    <label class="switch ">
                                        <input type="checkbox" class="default" name="active" value="1"  @if($area->active == 1) checked @endif >
