                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="shortDescription" id="shortDescription1" rows="4"
                                ...
                                <fieldset>
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="c-select form-control" id="eventType1"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="c-select form-control" id="eventLocation1"
                                                        name="location">
                                                    <option value="">Select City</option>
                                                    <option value="Amsterdam">Amsterdam</option>
                                                    <option value="Berlin">Berlin</option>
                                  ...
                                  <span class="ft-calendar"></span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="c-select form-control" id="eventStatus1"
                                                        name="eventStatus">
                                                ...
                                                <div class="c-inputs-stacked">
                                                    <div class="d-inline-block custom-control custom-checkbox">
                                                        ...
                                                        <label class="custom-control-label"
                                                               for="staffing1">Staffing</label>
                                                    </div>
                                                    <div class="d-inline-block custom-control custom-checkbox">
                                                        <input type="checkbox" name="status1"
                                                               class="custom-control-input" id="catering1">
                                                        <label class="custom-control-label"
                                                               for="catering1">Catering</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
