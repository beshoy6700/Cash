            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        {{ Breadcrumbs::render('edit_city',$city) }}
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title text-center"><strong> تعديل {{$city->name}} </strong></h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    {!! Form::model($city, array('method' =>'PATCH','class'=>'form-horizontal','files'=>true,'role'=>'form',
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select("state_id",$states,null,array('required','class'=>'form-control round select2','placeholder'=>'اختار المدينة','autocomplete'=>'off')) !!}
                                </div>
                                @error("state_id")
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    <label class="switch ">
                                        <input type="checkbox" class="default" name="active" value="1"  @if($city->active == 1) checked @endif >
