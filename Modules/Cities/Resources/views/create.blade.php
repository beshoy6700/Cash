    ...
    <div class="content-header row">
        ...
        <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    {{ Breadcrumbs::render('create_city') }}
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title text-center" id="basic-layout-round-controls"><strong>اضافة مدينة جديدة</strong></h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        {!! Form::open(array('route'=>'cities.store','class'=>'form-horizontal','files'=>true,'role'=>'form')) !!}
                        @csrf
                        <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text("name",null,array('required','class'=>'form-control round','placeholder'=>'المدينة','autocomplete'=>'off')) !!}
                                            </div>
                                            @error("name")
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="state_id">المحافظات</label>
                                        {!! Form::select("state_id",$states,null,array('required','class'=>'form-control round select2','placeholder'=>'اختار المحافظة','autocomplete'=>'off')) !!}
                                    </div>
                                    @error("state_id")
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
